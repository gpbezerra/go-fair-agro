        ...
        <div id="Implementação" className="videoContainer">
            ...
            <div className="implementationCardDeck">
                ...
                <div id="implementationMaterial" className="implementationCard">
                    ...
                    <a id="buttonDefault" href="https://drive.google.com/file/d/1GJJClgQgGCBiZJwVlq4UJiJs92dr_99j/view?usp=share_link">Assistir</a>
                </div>
                <div id="implementarionOficina" className="implementationCard">
