        ...
        <div id="Publicações" className="postContainer">
                ...
                <div className="postCardDeck">
                    <div className="postCard">
                        ...
                        <a id="buttonBlue" href="https://ainfo.cnptia.embrapa.br/digital/bitstream/item/228163/1/PL-Implantacao-Rede-GO-FAIR-SBIAgro-2021.pdf">Ler pdf</a>
                    </div>
                    ...
                    <div className="postCard">
                        ...
                        <a id="buttonBlue"  href="https://ainfo.cnptia.embrapa.br/digital/bitstream/item/227340/1/PL-Rumo-a-rede-de-implantacao-2021.pdf">Ler pdf</a>
                    </div>
                </div>
        </div>
    );
